            ...
            {reservationSuccess ? (
              ...
              <form onSubmit={handleReservationSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <input required name="date" type="date" min={new Date().toISOString().split("T")[0]} className="w-full min-w-0 bg-[#1F1C18] border border-white/10 rounded-xl px-4 py-3 text-xs text-white outline-none focus:border-[#D4AF37] [color-scheme:dark]" />
                  <input required name="time" type="time" className="w-full min-w-0 bg-[#1F1C18] border border-white/10 rounded-xl px-4 py-3 text-xs text-white outline-none focus:border-[#D4AF37] [color-scheme:dark]" />
                </div>
                {reservationError && (
